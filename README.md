...
* [C# SNMP Library](https://github.com/lextudio/sharpsnmplib) ⭐ 404 | 🐛 11 | 🌐 C# | 📅 2026-05-16 - MIT licensed SNMP library for .NET with extensive SNMP standard support, latest .NET platform targets, as well as rich manager/agent samples.
...
* [Scapy](https://github.com/secdev/scapy) ⭐ 12,483 | 🐛 134 | 🌐 Python | 📅 2026-08-18 - Packet manipulation program & library. Scapy has a [module](https://github.com/secdev/scapy/blob/master/scapy/layers/snmp.py) ⭐ 12,483 | 🐛 134 | 🌐 Python | 📅 2026-08-18 to build/dissect SNMP packets. ![GitHub last commit](https://img.shields.io/github/last-commit/secdev/scapy)
...
* [prometheus/snmp\_exporter](https://github.com/prometheus/snmp_exporter) ⭐ 2,163 | 🐛 102 | 🌐 Go | 📅 2026-08-19 - This exporter is the recommended way to expose SNMP data in a format which Prometheus can ingest.
...
* [TWSNMP FK](https://github.com/twsnmp/twsnmpfk) ⭐ 7 | 🐛 0 | 🌐 Go | 📅 2026-08-21 - An ultra-lightweight SNMP manager for Windows and Mac OS, featuring network mapping, polling, and AI analysis.
