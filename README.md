...
* [C# SNMP Library](https://github.com/lextudio/sharpsnmplib) ⭐ 403 | 🐛 12 | 🌐 C# | 📅 2026-05-16 - MIT licensed SNMP library for .NET with extensive SNMP standard support, latest .NET platform targets, as well as rich manager/agent samples.
...
* [Scapy](https://github.com/secdev/scapy) ⭐ 12,553 | 🐛 143 | 🌐 Python | 📅 2026-09-18 - Packet manipulation program & library. Scapy has a [module](https://github.com/secdev/scapy/blob/master/scapy/layers/snmp.py) ⭐ 12,553 | 🐛 143 | 🌐 Python | 📅 2026-09-18 to build/dissect SNMP packets. ![GitHub last commit](https://img.shields.io/github/last-commit/secdev/scapy)
...
* [gufo\_snmp](https://github.com/gufolabs/gufo_snmp) ⭐ 24 | 🐛 9 | 🌐 Rust | 📅 2026-09-18 - The accelerated Python SNMP client library supporting both async and synchronous mode. It consists of a clean Python API for high-efficient BER parser and socket IO, implemented in the Rust language with PyO3 wrapper. Seems to be a bit early in the project's lifecycle, but it is easy to use and ***extremely*** fast, especially when querying many devices. ![GitHub last commit](https://img.shields.io/github/last-commit/gufolabs/gufo_snmp)
...
* [prometheus/snmp\_exporter](https://github.com/prometheus/snmp_exporter) ⭐ 2,172 | 🐛 103 | 🌐 Go | 📅 2026-09-18 - This exporter is the recommended way to expose SNMP data in a format which Prometheus can ingest.
